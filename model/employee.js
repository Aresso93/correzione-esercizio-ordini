class Employee extends Person{
    ...
    bestClient(){
        ...
        //return this.clients.reduce((a, c) => a ? (a.totalExpenses() > c.totalExpenses() ? a : c): c, null)             sintassi molto raffinata ma molto poco leggibile
        ...
        if (this.clients.length === 0){                //se non ho alcun cliente (l'array ha lunghezza 0), non posso avere alcun miglior cliente: ritorno null
            return null;
        } 
